(function registerAeroplaneChessRenderer() {
  ...
  const HOME_LANE_POINTS = {
    red: [[50, 85.5], [50, 80.4], [50, 75.3], [50, 70.2], [50, 65.1], [50, 60]],
    yellow: [[14.5, 50], [19.6, 50], [24.7, 50], [29.8, 50], [34.9, 50], [40, 50]],
    blue: [[50, 14.5], [50, 19.6], [50, 24.7], [50, 29.8], [50, 34.9], [50, 40]],
    green: [[85.5, 50], [80.4, 50], [75.3, 50], [70.2, 50], [65.1, 50], [60, 50]],
  };
  const HOME_POINTS = {
